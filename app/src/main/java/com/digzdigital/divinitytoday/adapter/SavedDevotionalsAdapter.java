...
// TODO: 02/11/2016 change to load more button
/**
...
public class SavedDevotionalsAdapter extends RecyclerView.Adapter<SavedDevotionalsAdapter.ViewHolder> {
    ...
    private RealmResults<Devotional> devotionals;
    private Context context;

    public SavedDevotionalsAdapter(RealmResults<Devotional> devotionals, Context context) {
