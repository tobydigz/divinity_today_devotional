...
class SavedDevotionalAdapter(myClickListener: DevotionalClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun removeDevotional(devotional: Devotional) {
        val index = getDevotionals().indexOf(devotional)
